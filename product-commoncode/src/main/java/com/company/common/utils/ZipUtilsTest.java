...
public class ZipUtilsTest {
	...
	public static void main(String[] args) throws Exception {
		//压缩
		/*File file = new File("E:/压缩测试");
		File zipFile = new File("E:/压缩测试.zip");
		ZipUtilsTest.compress(file,zipFile);*/
		//解压
		File zipFile = new File("E:/压缩测试.zip");
		File file = new File("E:/英雄时刻");
		ZipUtilsTest.uncompress(zipFile,file);
	}
